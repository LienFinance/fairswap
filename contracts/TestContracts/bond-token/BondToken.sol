...
import "./TransferETH.sol"; // this contract has payable function
import "../../../node_modules/@openzeppelin/contracts/token/ERC20/ERC20.sol";
import "./BondTokenInterface.sol";
import "./DeployerRole.sol";

contract BondToken is BondTokenInterface, TransferETH, ERC20, DeployerRole {
    struct Frac128x128 {
        uint128 numerator;
        uint128 denominator;
    }
